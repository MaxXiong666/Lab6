...
```
C:\miniconda\python.exe "D:/Courses/Open Source/Lab/6/Part1.py"
...
```
C:\miniconda\python.exe "D:/Courses/Open Source/Lab/6/Part2.py"
Loaded words_dat.txt containing 5757 five-letter English words.
Two words are connected if they differ in one letter.
...
###Output
```
C:\miniconda\python.exe "D:/Courses/Open Source/Lab/6/Part3.py"
Loaded words_dat.txt containing 5757 five-letter English words.
Two words are connected if they differ in one letter.
